		...
		<table class="list">
			...
			<tbody>
				...
				<tr>
					...
					<td><img src="${ row.pcImg }" id="pcImgTag"></td>
					<td><c:out value="${ row.gubun eq 1 ? '제품배너' : (row.gubun eq 2 ? '이벤트 배너' : '긴급배너') }" /></td>
					<td><a href="edit?bno=${ row.bno }"><c:out value="${ row.title }" /></a></td>
