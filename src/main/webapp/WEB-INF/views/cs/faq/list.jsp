	...
	<div id="container">
		...
		<div class="white_box">
			<table class="board">
				...
				<tr>
					<th>질문</th>
					<td colspan=3>
						<input type="text" name="question" value="${ param.question }" style="width:100%" >
					</td>
				</tr>
				<tr>
					<th>분류</th>
		...
		<table class="list">
			...
			<tbody>
				...
				<tr>
					<td><c:out value="${ row.faqNo }" /></td>
					<td><c:out value="${ row.cateName }" /></td>
					<td><a href="edit?faqNo=${ row.faqNo }"><c:out value="${ row.question }" /></a></td>
