		...
		<div class="white_box">
			<table class="board">
				...
				<tr>
					<th>상단 고정</th>
					<td colspan=3>
						<label><input type="radio" name="fixYn" value="" ${ empty param.fixYn ? 'checked' : '' }><span>전체</span></label>
						<label><input type="radio" name="fixYn" value="Y" ${ param.fixYn eq 'Y' ? 'checked' : '' }><span>Y</span></label>
						<label><input type="radio" name="fixYn" value="N" ${ param.fixYn eq 'N' ? 'checked' : '' }><span>N</span></label>
					</td>
				</tr>
			</table>
