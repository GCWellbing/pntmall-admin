...
<c:import url="/include/header" />
	<div id="container">
		...
		<table class="list">
			...
			<tbody>
				<form name="editForm" id="editForm" method="POST" action="setReviewSeq">
					...
					<c:forEach items="${ list }" var="row" varStatus="status">
						...
						<tr>
							...
							<td>
								<input type="hidden" name="reviewSeqOld${status.index}" value="${ row.reviewSeq }" style="width:100%" >
								<input type="text" name="reviewSeq${status.index}" value="${ row.reviewSeq }" style="width:100%" >
							</td>
