			...
			<tbody>
				...
				<c:forEach items="${ list }" var="row">
					...
					<tr>
						...
						<td>PC</td>
						<td class="ar"><fmt:formatNumber value="${ row.get('pc_m_amt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('pc_m_cnt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('pc_m_mem_cnt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('pc_m_qty') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('pc_w_amt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('pc_w_cnt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('pc_w_mem_cnt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('pc_w_qty') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('pc_n_amt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('pc_n_cnt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('pc_n_mem_cnt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('pc_n_qty') }" pattern="#,###" /></td>
					</tr>
					<tr>
						<td>모바일</td>
						<td class="ar"><fmt:formatNumber value="${ row.get('mo_m_amt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('mo_m_cnt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('mo_m_mem_cnt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('mo_m_qty') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('mo_w_amt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('mo_w_cnt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('mo_w_mem_cnt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('mo_w_qty') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('mo_n_amt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('mo_n_cnt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('mo_n_mem_cnt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('mo_n_qty') }" pattern="#,###" /></td>
					</tr>
					<tr>
						<td>앱</td>
						<td class="ar"><fmt:formatNumber value="${ row.get('ap_m_amt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('ap_m_cnt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('ap_m_mem_cnt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('ap_m_qty') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('ap_w_amt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('ap_w_cnt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('ap_w_mem_cnt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('ap_w_qty') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('ap_n_amt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('ap_n_cnt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('ap_n_mem_cnt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('ap_n_qty') }" pattern="#,###" /></td>
					</tr>
					<tr>
						<td>총액</td>
						<td class="ar"><fmt:formatNumber value="${ row.get('m_amt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('m_cnt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('m_mem_cnt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('m_qty') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('w_amt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('w_cnt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('w_mem_cnt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('w_qty') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('n_amt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('n_cnt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('n_mem_cnt') }" pattern="#,###" /></td>
						<td class="ar"><fmt:formatNumber value="${ row.get('n_qty') }" pattern="#,###" /></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
